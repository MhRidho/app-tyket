...
<body>
  ...
  ***********************************-->
    ...
    ***********************************-->
        ...
        <img class="brand-title" src="./images/logo-text.png" alt=""> -->
                ...
                <h2 class="brand-title" style="color:#FD841F; font-weight:900">KONSER TICKET</h2>
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">Data Ticketing</div>
                        </div>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li>
                        <a class="ai-icon" href="{{ Route('buyer.index') }}" aria-expanded="false">
                            <i class="flaticon-381-user"></i><span class="nav-text">Buyer</span>
                        </a>
                    </li>
                    <li>
                        <a class="ai-icon" href="{{ Route('ticket.index') }}" aria-expanded="false">
                            <i class="flaticon-381-trophy"></i><span class="nav-text">Ticket</span>
                        </a>
                    </li>
                    <li>
                        <a class="ai-icon" href="{{ Route('transaksi.index') }}" aria-expanded="false">
                            <i class="flaticon-381-television"></i><span class="nav-text">Transaksi</span>
                        </a>
                    </li>
                    {{--
                    <li class="#">
  ...
  ***********************************-->
    ...
    ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://getbootstrap.com/"
                        target="_blank">Bootstrap</a> 2022</p>
            </div>
        </div>
        <!--**********************************
        Footer end
